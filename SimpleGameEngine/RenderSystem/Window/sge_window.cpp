...
void SGE::Window::createWindow() {
	...
	this->window = SDL_CreateWindow("SGE", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 
		this->width, this->height, SDL_WINDOW_OPENGL | SDL_WINDOW_HIDDEN);
...
void SGE::Window::showWindow() noexcept {
	SDL_ShowWindow(this->window);
}

void SGE::Window::finalizeWindow() noexcept {
	SDL_DestroyWindow(this->window);
}

SDL_Window* SGE::Window::getWindow() noexcept {
	return this->window;
}
